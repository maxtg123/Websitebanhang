        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TransportFee = table.Column<int>(type: "int", nullable: false),
                    TransportFreeMoney = table.Column<int>(type: "int", nullable: false),
                    QuantityProductNotification = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProcessDT = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Content = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HandleWhat = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HandleWhatId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProcessHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProcessHistories_Accounts_AccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProcessHistories_AccountId",
